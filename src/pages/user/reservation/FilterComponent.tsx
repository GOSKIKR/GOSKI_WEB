...
const FilterComponent: React.FC<FilterComponentProps> = ({
    ...
    const [filterLessonLocation, setFilterLessonLocation] =
        useState<string>("");
    ...
    return (
        <div className="w-full flex flex-col items-center space-y-5 py-10">
            ...
            <div className="flex flex-wrap bg-primary-50 rounded-lg shadow-md sm:mx-5 p-5 space-y-5 sm:space-y-0 justify-between">
                ...
                <div className="flex justify-center w-full pt-5">
                    ...
                    >
                        <IoIosSearch size="20" />
                        <span className="ml-2 text-base">검색</span>
                    </button>
                </div>
            </div>
        </div>
