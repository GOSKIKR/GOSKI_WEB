...
#### 1. 로그인, 회원가입
| <img src="exec/screen/로그인.png" width="350px" /> | <img src="exec/screen/회원가입.png" width="350px" /> | <img src="exec/screen/비밀번호찾기.png" width="350px" /> | 
| :------------------------------------: | :----------------------------------------: |  :----------------------------------------: | 
|               로그인                |                회원가입                 |     비밀번호 찾기                 |        

#### 2. 메인 페이지
| <img src="exec/screen/유저메인.png" width="350px" /> | <img src="exec/screen/유저메인.gif" width="350px" /> |
| :------------------------------------: | :----------------------------------------: |
|               유저 메인 페이지           | 유저 메인 페이지(gif)                                  | 

#### 3. 강습 예약

| <img src="exec/screen/필터설정.png" width="350px" /> | <img src="exec/screen/팀결과.png" width="350px" /> | <img src="exec/screen/강사결과.png" width="350px" /> |
| :------------------------------------: | :----------------------------------------: | :-------------------------------------------: |
...
#### 4. 마이페이지 
| <img src="exec/screen/mypage1.gif" width="350px" /> | <img src="exec/screen/피드백확인.png" width="350px" /> | <img src="exec/screen/리뷰작성.png" width="350px" /> | <img src="exec/screen/개인정보수정.png" width="350px" /> |
| :------------------------------------: | :----------------------------------------: | :-------------------------------------------: |:-------------------------------------------: |
|                강습/결제 내역                 |                피드백 조회                 |                   리뷰 작성                   |     개인 정보 수정                   |
...
#### 2. 메인 페이지
| <img src="exec/screen/instMain.png" width="350px" /> | <img src="exec/screen/createEvent.gif" width="300px" /> | <img src="exec/screen/eventDetail.gif" width="300px" /> |
| :------------------------------------: | :----------------------------------------: | :-------------------------------------------: |
|                일정 확인                 |                팀 일정 등록                 |                   일정 상세                   |
