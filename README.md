...
| ![필터 설정](./assets/screen/필터설정.png) | ![필터 설정 결과 - 초급](./assets/screen/팀결과.png) | ![필터 설정 결과 - 중급, 고급](./assets/screen/강사결과.png) |
| :------------------------------------: | :----------------------------------------: | :-------------------------------------------: |
|               필터 설정                |                필터 설정 결과 - 초급                 |                   필터 설정 결과 - 중급, 고급                    |       
| ![초급(팀) 상세 페이지](./assets/screen/.png) | ![중,고급(강사) 상세 페이지](./assets/screen/강사상세.png) |
| :------------------------------------: | :----------------------------------------: | 
|               초급(팀) 상세 페이지                |                중,고급(강사) 상세 페이지                 |  
| ![지정 강사 선택](./assets/screen/지정강사선택.png) | ![결제](./assets/screen/결제하기.png) |
| :------------------------------------: | :----------------------------------------: | 
|               지정 강사 선택                |                결제                 |  

#### 3. 마이페이지 
| ![강습/결제 내역](./assets/screen/mypage1.gif) | ![피드백 조회](./assets/screen/피드백확인.png) | ![리뷰 작성](./assets/screen/리뷰작ㄱ성.png) |
| :------------------------------------: | :----------------------------------------: | :-------------------------------------------: |
...
#### 2. 메인 페이지
| ![일정 확인](./assets/screen/instMain.png) | ![팀 일정 등록](./assets/screen/createEvent.gif) | ![일정 상세](./assets/screen/eventDetail.gif) |
| :------------------------------------: | :----------------------------------------: | :-------------------------------------------: |
|                일정 확인                 |                팀 일정 등록                 |                   일정 상세                   |
